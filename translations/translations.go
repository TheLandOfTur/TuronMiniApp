...
var (
	translations = map[string]map[string]string{
		"ru": {
			...
			"chooseRole":                  "Пожалуйста, выберите тип пользователя:",
			"abonent":                     "📱 Я активный абонент",
			"user":                        "👤 Хочу установить Wi-Fi",
			"pleaseSelectYurDistrict":     "Пожалуйста, выберите город для подключения интернета!",
			...
			"applicationSentSuccessfully": "✅ Поздравляем! Ваша заявка успешно принята",
		...
		"uz": {
			...
			"chooseRole":                  "Iltimos, foydalanuvchi turini tanlang:",
			"abonent":                     "📱 Faol abonentman",
			"user":                        "👤 Wi-Fi o'rnatmoqchiman",
			"pleaseSelectYurDistrict":     "Iltimos, internet ulanadigan shaharni tanlang!",
			...
			"applicationSentSuccessfully": "✅ Tabriklaymiz! Arizangiz muvaffaqiyatli qabul qilindi",
